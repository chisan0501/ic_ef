...
<ObjectInfo>\
	...
	<ObjectInfo>\
		...
		<Bounds X="336" Y="2578.68896484375" Width="363.644439697266" Height="551.200012207031" />\
                ...
                var channel_name =document.getElementById('channel').innerHTML;
                var product_name = document.getElementById('product').innerHTML;
                var manu = document.getElementById('model').innerHTML;
                var cpu = document.getElementById('cpu').innerHTML;
                var ram = document.getElementById('ram').innerHTML;
                var hdd = document.getElementById('hdd').innerHTML;
                var time = document.getElementById('time').innerHTML;
                var serial = document.getElementById('serial').innerHTML;
                var asset_tag = document.getElementById('asset_tag').innerHTML;
